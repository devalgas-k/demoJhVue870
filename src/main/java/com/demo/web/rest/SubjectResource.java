...
/**
 * REST controller for managing {@link com.demo.domain.Subject}.
 */
@RestController
...
public class SubjectResource {
    ...
    public ResponseEntity<SubjectDTO> createSubject(@Valid @RequestBody SubjectDTO subjectDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/subjects/" + subjectDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, subjectDTO.getId().toString()))
            .body(subjectDTO);
    }
