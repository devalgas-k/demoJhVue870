  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="demoJhVue870App.department.home.createOrEditLabel"
          data-cy="DepartmentCreateUpdateHeading"
          v-text="t$('demoJhVue870App.department.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('demoJhVue870App.department.departmentName')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('demoJhVue870App.department.location')" for="department-location"></label>
            <select class="form-control" id="department-location" data-cy="location" name="location" v-model="department.location">
              <option :value="null"></option>
              <option
                :value="department.location && locationOption.id === department.location.id ? department.location : locationOption"
