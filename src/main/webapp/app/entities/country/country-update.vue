  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="demoJhVue870App.country.home.createOrEditLabel"
          data-cy="CountryCreateUpdateHeading"
          v-text="t$('demoJhVue870App.country.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('demoJhVue870App.country.countryName')" for="country-countryName"></label>
            <input
              type="text"
              class="form-control"
              name="countryName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('demoJhVue870App.country.region')" for="country-region"></label>
