  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="demoJhVue870App.task.home.createOrEditLabel"
          data-cy="TaskCreateUpdateHeading"
          v-text="t$('demoJhVue870App.task.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('demoJhVue870App.task.title')" for="task-title"></label>
            <input
              type="text"
              class="form-control"
              name="title"
