...
type ExperienceComponentType = InstanceType<typeof Experience>;
...
describe('Component Tests', () => {
  ...
  describe('Experience Management Component', () => {
    ...
    let mountOptions: MountingOptions<ExperienceComponentType>['global'];
    ...
    describe('Mount', () => {
      it('Should call load all on init', async () => {
        ...
        // WHEN
        const wrapper = shallowMount(Experience, { global: mountOptions });
        const comp = wrapper.vm;
        await comp.$nextTick();

        // THEN
        expect(experienceServiceStub.retrieve.calledOnce).toBeTruthy();
      ...
      it('should calculate the sort attribute for an id', async () => {
        ...
        // THEN
        expect(experienceServiceStub.retrieve.lastCall.firstArg).toMatchObject({
          sort: ['id,asc'],
        });
      });
    });
    describe('Handles', () => {
      let comp: ExperienceComponentType;
      ...
      beforeEach(async () => {
        ...
        experienceServiceStub.retrieve.resolves({ headers: {}, data: [] });
      });
