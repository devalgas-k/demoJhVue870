<template>
  <div>
    <h2 id="page-heading" data-cy="EmployeeHeading">
      <span v-text="t$('demoJhVue870App.employee.home.title')" id="employee-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('demoJhVue870App.employee.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'EmployeeCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('demoJhVue870App.employee.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && employees && employees.length === 0">
      <span v-text="t$('demoJhVue870App.employee.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="employees">
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('firstName')">
              <span v-text="t$('demoJhVue870App.employee.firstName')"></span>
            ...
            <th scope="row" @click="changeOrder('lastName')">
              <span v-text="t$('demoJhVue870App.employee.lastName')"></span>
            ...
            <th scope="row" @click="changeOrder('email')">
              <span v-text="t$('demoJhVue870App.employee.email')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'email'"></jhi-sort-indicator>
            </th>
            <th scope="row" @click="changeOrder('phoneNumber')">
              <span v-text="t$('demoJhVue870App.employee.phoneNumber')"></span>
            ...
            <th scope="row" @click="changeOrder('hireDate')">
              <span v-text="t$('demoJhVue870App.employee.hireDate')"></span>
            ...
            <th scope="row" @click="changeOrder('salary')">
              <span v-text="t$('demoJhVue870App.employee.salary')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'salary'"></jhi-sort-indicator>
            </th>
            <th scope="row" @click="changeOrder('commissionPct')">
              <span v-text="t$('demoJhVue870App.employee.commissionPct')"></span>
            ...
            <th scope="row" @click="changeOrder('level')">
              <span v-text="t$('demoJhVue870App.employee.level')"></span>
            ...
            <th scope="row" @click="changeOrder('contract')">
              <span v-text="t$('demoJhVue870App.employee.contract')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'contract'"></jhi-sort-indicator>
            </th>
            <th scope="row" @click="changeOrder('cv')">
              <span v-text="t$('demoJhVue870App.employee.cv')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'cv'"></jhi-sort-indicator>
            </th>
            <th scope="row" @click="changeOrder('manager.id')">
              <span v-text="t$('demoJhVue870App.employee.manager')"></span>
            ...
            <th scope="row" @click="changeOrder('department.id')">
              <span v-text="t$('demoJhVue870App.employee.department')"></span>
        ...
        <tbody>
          <tr v-for="employee in employees" :key="employee.id" data-cy="entityTable">
            ...
            <td v-text="t$('demoJhVue870App.Contract.' + employee.contract)"></td>
            <td>
              <a v-if="employee.cv" @click="openFile(employee.cvContentType, employee.cv)" v-text="t$('entity.action.open')"></a>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="demoJhVue870App.employee.delete.question" data-cy="employeeDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-employee-heading" v-text="t$('demoJhVue870App.employee.delete.question', { id: removeId })"></p>
      </div>
