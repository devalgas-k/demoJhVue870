  ...
  describe('Employee Service', () => {
    ...
    describe('Service methods', () => {
      it('should find an element', async () => {
        const returnedFromService = { hireDate: dayjs(currentDate).format(DATE_TIME_FORMAT), ...elemDefault };
      ...
      it('should create a Employee', async () => {
        const returnedFromService = { id: 123, hireDate: dayjs(currentDate).format(DATE_TIME_FORMAT), ...elemDefault };
