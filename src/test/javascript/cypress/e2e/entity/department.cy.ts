...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'demain de crainte que' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('fidèle antagoniste présidence');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'fidèle antagoniste présidence');
