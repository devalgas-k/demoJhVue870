...
describe('Subject e2e test', () => {
  ...
  const subjectSample = { name: 'certainement' };
  ...
  describe('new Subject page', () => {
    ...
    it('should create an instance of Subject', () => {
      cy.get(`[data-cy="name"]`).type('remplacer de crainte que atchoum');
      cy.get(`[data-cy="name"]`).should('have.value', 'remplacer de crainte que atchoum');
